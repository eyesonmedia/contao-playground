...
$GLOBALS['TL_LANG']['eonm_registration']['copy'] = ['Anmeldung kopieren', 'Kopiere Anmeldung %s'];
$GLOBALS['TL_LANG']['eonm_registration']['cut'] = ['Anmeldung ausschneiden', 'Schneide Anmeldung %s aus'];
...
$GLOBALS['TL_LANG']['eonm_registration']['email'] = ['E-Mail', 'E-Mail'];
$GLOBALS['TL_LANG']['eonm_registration']['birthday'] = ['Geburtsdatum', 'Geburtsdatum'];
$GLOBALS['TL_LANG']['eonm_registration']['phone'] = ['Telefon', 'Telefon'];
$GLOBALS['TL_LANG']['eonm_registration']['street'] = ['Straße und Hausnummer', 'Straße und Hausnummer'];
$GLOBALS['TL_LANG']['eonm_registration']['zip'] = ['PLZ', 'PLZ'];
$GLOBALS['TL_LANG']['eonm_registration']['city'] = ['Stadt', 'Stadt'];
$GLOBALS['TL_LANG']['eonm_registration']['registerdate'] = ['Gebuchter Termin', 'Gebuchter Termin'];
