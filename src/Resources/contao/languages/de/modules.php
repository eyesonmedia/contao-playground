...
$GLOBALS['TL_LANG']['MOD']['NuvisanManageIntern'] = ['Interne Anmeldungen', 'Verwalten von internen Studienanmeldungen'];
$GLOBALS['TL_LANG']['MOD']['NuvisanManageStudy'] = ['Studienverwaltung', 'Verwalten von Studienverwaltung'];
