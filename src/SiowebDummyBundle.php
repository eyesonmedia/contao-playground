...
#var_dump($searchData);die;
    ...
    public function exportInternRegistration(\Contao\DC_Table $dc)
    {


        $exportData = array();

        $registrationData = \Contao\System::getContainer()->get('sioweb_dummybundle.service.search')->getInternRegistrationTable();
...
#var_dump($searchData);die;
        ...
        \System::getContainer()->get('sioweb_dummybundle.service.search')->outputCsv('export-intern-registrations-'.time().'.csv', $exportData);
